...
let
  ...
  buildPhaseCargoCommand = "cargo build --release || (ls -la /build/source/target/release/build/libc-ff4c016e9ae90a0f/build-script-build; RUST_BACKTRACE=1 /build/source/target/release/build/libc-ff4c016e9ae90a0f/build-script-build)";
   });
